...
class Style:
    ...
    def stroke_params(self) -> dict:
        ...
        defaults = {
            ...
            # VENETIAN_ROMAN_SYNTHESIS (Sebastiano del Piombo) — Venetian richness + Roman
            # sculptural weight. stroke_size_face=6: careful, deliberate Venetian mark-making
            # fused with Roman monumental gravity — not impulsive, not finicky.
            # stroke_size_bg=24: backgrounds carry Roman architectural grandeur — larger marks
            # for deep, rich environmental space. wet_blend=0.78: strong Venetian blending
            # inheritance — surfaces are smooth, deeply fused, with no visible canvas tooth.
            ...
            # LATE_FLORENTINE_QUATTROCENTO (Filippino Lippi) — nervous energy, vivid chromatic tension.
            # stroke_size_face=5: precise Florentine disegno — careful marks that honour the
            # draughtsmanship tradition without the micro-precision of Northern miniaturists.
            # stroke_size_bg=22: moderate for architectural and landscape backgrounds.
            # wet_blend=0.40: moderate — zones are distinct and vivid, not Venetian-blended,
            # but not the absolute dryness of enamel painters; some transition in mid-tones.
            ...
            # SIENESE_LEONARDESQUE (Sodoma): Sienese golden warmth fused with Leonardesque sfumato.
            # stroke_size_face=5: small mark size suited to Sodoma's careful flesh modelling.
            # stroke_size_bg=20: moderate — Sodoma's landscape backgrounds were carefully resolved.
            ...
            # VENETIAN_INTIMATE_COLORISM (Paris Bordone): Titian-school warmth with Giorgionesque atmospheric softness.
            # stroke_size_face=6: medium Venetian flesh mark — broader than Sodoma, narrower than Titian.
            # stroke_size_bg=22: moderate — Bordone's backgrounds are softly resolved atmospheric landscape.
            # wet_blend=0.72: high Venetian blending from Titian-school training.
            # edge_softness=0.68: soft Giorgionesque dissolution — not full sfumato, but warm atmospheric.
            Period.VENETIAN_INTIMATE_COLORISM: dict(stroke_size_face=6, stroke_size_bg=22, wet_blend=0.72, edge_softness=0.68),
            # BRESCIAN_VENETIAN_IMPASTO (Romanino): bold loaded brushwork, Venetian-influenced colour,
            # vigorous impasto marks with high blending but firm edge definition from loaded brush.
            # stroke_size_face=7: larger than Bordone — Romanino's brush is heavier and more assertive.
            # stroke_size_bg=26: expansive background strokes — Romanino's fresco-scale gestures.
            # wet_blend=0.58: moderate Venetian blending — less than Bordone; ridged impasto resists
            #                  full dissolution.
            # edge_softness=0.42: firm edges — impasto ridges define form rather than dissolving it.
            Period.BRESCIAN_VENETIAN_IMPASTO: dict(stroke_size_face=7, stroke_size_bg=26, wet_blend=0.58, edge_softness=0.42),
            # SIENESE_MANNERIST_LUMINISM (Beccafumi): Sienese Mannerist luminosity, acid palette, nacreous iridescence.
            # stroke_size_face=5: refined Sienese marking — smaller than Romanino, precise Mannerist detail.
            # stroke_size_bg=20: moderate background stroke — Beccafumi's altarpieces have detailed settings.
            ...
            # LOMBARDY_VENETIAN_JEWEL_REALISM (Bartolomeo Veneto): cool precision; meticulous surface; Lombard-Venetian jewel palette.
            # stroke_size_face=5: very fine — almost enamel-like surface precision, slightly larger than Furini.
            # stroke_size_bg=20: restrained background — simple dark grounds allow costume to read as jewel-bright.
            ...
            # BRITISH_GRAND_MANNER (Joshua Reynolds) — Grand Manner Academic warmth; moderate blending; softened edges.
            # stroke_size_face=7: bold Academic mark-making — Reynolds painted with confidence, not miniaturist precision.
            # stroke_size_bg=28: atmospheric landscape backgrounds, loosely handled in the Old Master tradition.
            ...
            # FRENCH_RENAISSANCE (François Clouet) — cool north-window light; precise crisp outlines (NOT sfumato); tight face strokes for court miniaturist finish;
            # high wet_blend for the enamel-smooth surface; moderate edge_softness (crisp but not harsh — Flemish precision without northern stiffness).
            Period.FRENCH_RENAISSANCE: dict(stroke_size_face=4, stroke_size_bg=16, wet_blend=0.76, edge_softness=0.44),
            ...
            # TONAL_STILL_LIFE (Pieter Claesz) — extreme tonal restraint, near-monochrome warm silver-gray;
            ...
            # BERGAMASK_PORTRAIT (Fra Galgario / Giuseppe Ghislandi) — intimate psychological portrait realism.
            # stroke_size_face=5: careful face modelling — Fra Galgario's faces are built with patient,
            # blended strokes; small enough for precise psychological characterisation.
            # stroke_size_bg=20: simple, subdued backgrounds — plain dark grounds, warm drapes, no landscape.
            # wet_blend=0.58: slightly higher than Ceruti — rich warm tonal continuity; "living surface" quality.
