"""
paint_mona_lisa_s96.py -- Session 96 portrait painting.

Paints the Mona Lisa-inspired portrait using the full stroke-engine pipeline,
with session-96 additions:

  - judith_leyster_joyful_light_pass()                     -- NEW (session 96) Judith Leyster.
...
def paint(out_dir: str = ".") -> str:
    """Run the full session-96 painting pipeline."""
    print("Session 96 -- Mona Lisa portrait")
    print("Random artist: Judith Leyster (Dutch Golden Age / Haarlem, 1609-1660)")
    print("New pass: judith_leyster_joyful_light_pass()")
    ...
    out_path = os.path.join(out_dir, "mona_lisa_s96.png")
    p.save(out_path)
