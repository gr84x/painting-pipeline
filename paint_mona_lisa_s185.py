"""
paint_mona_lisa_s185.py — Mona Lisa portrait for session 185.
...
Artistic discovery (session 185): Fra Galgario (Giuseppe Ghislandi, 1655–1743)
  - Bergamask painter, Franciscan lay brother, "the Rembrandt of Bergamo"
  - Intimate psychological portraits of Bergamask nobles — directness, dignity,
    and the quality his contemporaries called "living surfaces"
  - Roots in Lombard tradition (Moroni, Ceruti) enriched by Rembrandt's warmth
  - Defining quality: inner luminescence — flesh that glows from within, not
    merely reflecting light but appearing to be a source of it
  - Knight of the Golden Spur (c. 1710), Young Man in Red (c. 1720–30),
    Portrait of Count Vailetti (c. 1720)

New pipeline enhancements (session 185):
  - fra_galgario_living_surface_pass: NINETIETH DISTINCT MODE
    MIDTONE-TO-HIGHLIGHT GAUSSIAN BELL-CURVE INNER LUMINESCENCE GATE:
    Targets the LIVING SURFACE ZONE (luma 0.35–0.80) with a Gaussian bell curve
    centred at the midtone-highlight junction (luma 0.58) — maximum effect at the
    peak of the zone, fading smoothly to zero at both boundaries (shadow edge and
    specular edge).  Injects warm amber-gold R/G lift in the gated zone: Fra
    Galgario's characteristic inner luminescence that makes flesh glow from within.
    NOVEL: FIRST pass to target the MIDTONE-TO-HIGHLIGHT TRANSITION ZONE with a
    Gaussian bell-curve peaked at the midtone-highlight junction (luma 0.58) —
    complementary to ceruti_dignity_shadow_pass (shadow zone 0.08–0.42) in that
    it enriches the UPPER half of the tonal range.

  - chromatic_temperature_field_pass: NINETY-FIRST DISTINCT MODE
    DUAL-DIRECTION LUMA-RAMP COLOUR TEMPERATURE GRADIENT:
    Implements the fundamental Old Master principle of warm lights / cool shadows
    via two independent linear ramp gates: a warm R boost for highlights (luma
    above warm_luma_lo) and a cool B boost for shadows (luma below cool_luma_hi).
    Creates the warm/cool temperature opposition that gives classical portraits
    spatial depth and atmospheric life.
    NOVEL: FIRST pass with a DUAL-DIRECTION LUMA-RAMP COLOUR TEMPERATURE gate —
    simultaneous warm push in highlights and cool push in shadows via separate
    linear ramps, rather than a single-direction threshold or constant overlay.
"""
...
def paint(output_path: str = "mona_lisa_s185.png") -> str:
    """Full Leonardo sfumato pipeline with session 185 Fra Galgario-inspired passes."""
    print("=" * 64)
    print("  Session 185 — Mona Lisa sfumato portrait")
    print("  Artistic discovery: Fra Galgario (Giuseppe Ghislandi, 1655–1743)")
    print("    'The Rembrandt of Bergamo' — Bergamask Portrait Realism")
    print("    Living surfaces: flesh that glows from within, not merely reflecting")
    print("    Knight of the Golden Spur, Young Man in Red, Portrait of Vailetti")
    print("    NINETIETH MODE: fra_galgario_living_surface_pass")
    print("    -- Midtone-to-highlight Gaussian bell-curve inner luminescence gate")
    print("    NINETY-FIRST MODE: chromatic_temperature_field_pass")
    print("    -- Dual-direction luma-ramp warm lights / cool shadows gradient")
    print("=" * 64)
    ...
    print("  [6/34] Edge sfumato dissolution pass ...")
    ...
    print("  [7/34] Figure contour atmosphere pass ...")
    ...
    print("  [8/34] Skin subsurface scatter pass ...")
    ...
    print("  [9/34] Tonal envelope pass ...")
    ...
    print("  [10/34] Selective focus pass ...")
    ...
    print("  [11/34] Massys bridge glazing pass ...")
    ...
    print("  [12/34] Reynolds Grand Manner mezzotint tone pass ...")
    ...
    print("  [13/34] Luminance gradient warmth pass ...")
    ...
    print("  [14/34] Warm ambient occlusion pass ...")
    ...
    print("  [15/34] Shadow color temperature pass ...")
    ...
    print("  [16/34] Multilayer atmospheric veil pass ...")
    ...
    print("  [17/34] Peripheral defocus pass ...")
    ...
    print("  [18/34] Luminance preserving chroma boost pass ...")
    ...
    print("  [19/34] Shadow chroma depth pass ...")
    ...
    print("  [20/34] Tonal bounded warmth pass ...")
    ...
    print("  [21/34] Canvas tooth texture pass ...")
    ...
    print("  [22/34] Chromatic vignette pass ...")
    ...
    print("  [23/34] Cesare da Sesto clarity pass ...")
    ...
    print("  [24/34] Benozzo Gozzoli pageant pass ...")
    ...
    print("  [25/34] Sirani contextual warmth pass [s183, 86th mode] ...")
    ...
    print("  [26/34] Adaptive tonal pivot pass [s183, 87th mode] ...")
    ...
    print("  [27/34] *** CERUTI DIGNITY SHADOW PASS [s184, 88th mode] ***")
    ...
    print("  [28/34] *** HUE COHERENCE FIELD PASS [s184, 89th mode] ***")
    ...
    print("  [29/34] *** FRA GALGARIO LIVING SURFACE PASS [s185, 90th mode] ***")
    ...
    print("  [30/34] *** CHROMATIC TEMPERATURE FIELD PASS [s185, 91st mode] ***")
    ...
    print("  [31/34] Chromatic edge halation pass ...")
    ...
    print("  [32/34] Skin subsurface scatter pass (final warm glow) ...")
    p.skin_subsurface_scatter_pass(
        scatter_sigma    = 3.5,
    ...
    print("  [33/34] Sfumato veil final ...")
    p.sfumato_veil_pass(
        ref,
        n_veils                      = 4,
        blur_radius                  = 8.0,
    ...
    print("  [34/34] Place lights, final glaze + finish ...")
    p.place_lights(ref, stroke_size=5, n_strokes=320)
    # Warm amber-gold glaze — Fra Galgario Bergamask golden quality
    p.glaze((0.68, 0.56, 0.36), opacity=0.038)
...
if __name__ == "__main__":
    out = sys.argv[1] if len(sys.argv) > 1 else "mona_lisa_s185.png"
    paint(out)
