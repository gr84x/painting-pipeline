"""
paint_mona_lisa_s102.py -- Session 102 portrait painting.

Paints the Mona Lisa-inspired portrait using the full stroke-engine pipeline,
with session-102 additions:

  - tissot                                                  -- NEW (session 102)
                                                           James Tissot
                                                           (1836–1902),
                                                           Victorian Social
                                                           Realism /
                                                           Aesthetic Movement.
                                                           Four-stage fashionable
                                                           gloss pass:
                                                           (1) Enamel surface
                                                           clarity -- mild
                                                           unsharp-mask in the
                                                           mid-tone band sharpens
                                                           fabric and skin detail
                                                           to a lacquer-like
                                                           finish;
                                                           (2) Specular surface
                                                           sheen -- luminance lift
                                                           in bright zones
                                                           simulates the specular
                                                           reflectance of fine
                                                           silk and satin;
                                                           (3) Chromatic richness
                                                           -- saturation boost in
                                                           warm mid-tones
                                                           replicates the vivid
                                                           fabric quality of his
                                                           fashionable interiors;
                                                           (4) Cool highlight
                                                           crystallization --
                                                           B-channel lift in
                                                           brightest zones turns
                                                           hot-white into
                                                           crystalline silk-white
                                                           under English
                                                           afternoon light.

  SESSION 102 ARTISTIC IMPROVEMENT -- atmospheric blue shift in sfumato:

                                                           The sfumato_veil_pass
                                                           gains a new
                                                           atmospheric_blue_shift
                                                           parameter (0.35) that
                                                           applies a cool blue-
                                                           grey colour temperature
                                                           shift to the upper
                                                           canvas after all veils
                                                           are composited.  This
                                                           complements the
                                                           existing depth_gradient
                                                           (opacity recession)
                                                           with a physical colour
                                                           temperature recession:
                                                           the distant rocky
                                                           landscape is not merely
                                                           hazier but cooler and
                                                           bluer, as Rayleigh
                                                           scattering through
                                                           depth demands.
                                                           Inspired by Tissot's
                                                           precise atmospheric
                                                           colour recession in
                                                           his outdoor Thames
                                                           scenes.

  Sessions 101 and earlier (retained):
...
Session 102 artistic character:

  The random artist for this session is James Tissot (1836–1902), a Frenchman
  who became one of Victorian London's most admired — and most commercially
  successful — painters of fashionable social life.  Born Jacques-Joseph Tissot
  in Nantes, he trained at the École des Beaux-Arts in Paris under Lamothe and
  Flandrin, absorbing the academic tradition's insistence on immaculate surface
  finish and the precise observation of textiles, light, and social gesture.  In
  Paris he moved in the circle of Degas, Manet, and Whistler — artists whose
  influence is visible in his bold cropping, photographic compositional
  intelligence, and interest in the transient moment rather than the timeless
  pose — but he never committed to Impressionist dissolution of form.  His edges
  are always found, his surfaces always finished.

  After the suppression of the Paris Commune in 1871 (in which he had
  participated as a member of the Garde Nationale), he fled to London and
  established himself with startling speed as the most fashionable portraitist
  of the English upper-middle classes.  His Thames-side studio in St John's
  Wood became a gathering place for the socially ambitious; his paintings of
  women on yacht decks, at garden parties, at the opera, in conservatories
  full of exotic plants became the visual record of a particular stratum of
  Victorian life — prosperous, fashionable, slightly nervous of its own
  position, and dressed to perfection.

  His technique is the academic tradition at its finest: warm-toned ground,
  thin layers built up through successive transparent glazes, no visible
  brushwork on the face or principal fabrics, a seamless transition from one
  tone to the next that reads as almost photographic from a distance.  But he
  is not cold.  His palette has a warmth — cream-ivory, warm amber of Thames
  afternoon light, the vivid terracotta-rose of fashionable dress — that keeps
  the surface alive and prevents the academic smoothness from feeling dead.  His
  deep navies and cool greys give the warm tones somewhere to push against.

  The defining technical quality that enters the pipeline as
  tissot_fashionable_gloss_pass() is a compound effect: the enamel surface
  clarity of highly polished academic oil, the specular sheen of silk and satin
  rendered at the scale of individual fibres, the chromatic richness of fashion-
  forward dress fabrics, and the cool crystalline quality of his brightest
  highlights — the white of a collar, the pale silk of a sleeve — which read as
  crisp and precise rather than warm and ivory as the sfumato tradition demands.

  In the context of this portrait, Tissot's contribution is one of crispness
  and materiality: after 101 sessions of atmospheric dissolution, glazing,
  and sfumato, the surface perhaps risks becoming too dissolved, too airborne.
  Tissot's gloss pass re-asserts the physical presence of fabric, skin, and the
  specific material quality of things.  The atmospheric blue shift improvement
  in the sfumato_veil_pass() sharpens the spatial logic of the background,
  ensuring the cool distance reads as distance and not as a warm, uniform haze.
"""
...
def paint(out_dir: str = ".") -> str:
    """Run the full session-102 painting pipeline."""
    print("Session 102 -- Mona Lisa portrait")
    print("Random artist: James Tissot (Victorian Social Realism / Aesthetic Movement, 1836–1902)")
    print("New pass: tissot_fashionable_gloss_pass()")
    print("  -- Enamel surface clarity: unsharp-mask mid-tones for lacquer-like precision")
    print("  -- Specular surface sheen: luminance lift simulates silk/satin reflectance")
    print("  -- Chromatic richness: saturation boost in warm mid-tones")
    print("  -- Cool highlight crystallization: B-channel lift for crisp English afternoon whites")
    print()
    print("Session 102 artistic improvement: atmospheric_blue_shift in sfumato_veil_pass")
    print("  Adds cool blue-grey colour temperature recession to upper canvas after veil compositing.")
    print("  The distant landscape is not merely hazier (depth_gradient) but cooler and bluer,")
    print("  matching Rayleigh scattering physics and Tissot's precise atmospheric colour recession.")
    print()
    ...
    p.sfumato_veil_pass(
        ...
        atmospheric_blue_shift  = 0.35,  # session 102 improvement
    )
    ...
    # ── SESSION 102: James Tissot fashionable gloss pass (NEW) ───────────────
    # James Tissot (1836–1902) -- Victorian Social Realism / Aesthetic Movement.
    # Four-stage academic surface quality:
    #   (1) Enamel surface clarity (clarity_str=0.11): unsharp-mask in mid-tones
    #       restores the lacquer-like precision that sfumato has dissolved
    #   (2) Specular surface sheen (sheen_thresh=0.72, sheen_strength=0.07):
    #       luminance lift simulates silk and satin reflectance
    #   (3) Chromatic richness (chroma_boost=0.06): saturation boost in warm
    #       mid-tones adds Tissot's vivid fabric quality
    #   (4) Cool highlight crystallization (highlight_cool=0.04): B-channel lift
    #       turns warm-ivory highlights into crisp English afternoon whites
    # opacity=0.27: adds material presence without overriding atmospheric depth
    print("James Tissot fashionable gloss pass (session 102 -- NEW)...")
    p.tissot_fashionable_gloss_pass(
        clarity_str     = 0.11,   # enamel clarity in mid-tones
        sheen_thresh    = 0.72,   # specular sheen above this luminance
        sheen_strength  = 0.07,   # sheen lift magnitude
        chroma_boost    = 0.06,   # saturation boost in warm mid-tones
        mid_lo          = 0.28,   # mid-tone zone lower bound
        mid_hi          = 0.72,   # mid-tone zone upper bound
        highlight_cool  = 0.04,   # B↑ R↓ in very bright zones
        blur_radius     = 4.0,    # Gaussian sigma for smooth zone transitions
        opacity         = 0.27,   # adds Tissot's clarity, respects sfumato depth
    )
    ...
    out_path = os.path.join(out_dir, "mona_lisa_s102.png")
    p.save(out_path)
