"""
paint_mona_lisa_s97.py -- Session 97 portrait painting.

Paints the Mona Lisa-inspired portrait using the full stroke-engine pipeline,
with session-97 additions:

  - bernardino_luini                                        -- NEW (session 97) Judith Leyster.
                                                           Three-stage Dutch candlelit genre
                                                           warmth technique: (1) Incandescent
                                                           highlight warm-lift -- in upper
                                                           highlight zones (lum > 0.65), add
                                                           a warm amber-peach shift (R+, G+
                                                           slightly, B-), simulating the
                                                           incandescent orange-amber of
                                                           Leyster's candlelit genre
                                                           illumination; (2) Shadow vitality
                                                           (warm imprimatura show-through) --
                                                           in deep shadow zones (lum < 0.28),
                                                           add a very slight warm brown lift
                                                           (R+ slightly, G+ less, B minimal),
                                                           simulating the warm ochre-brown
                                                           Haarlem imprimatura showing through
                                                           thin shadow glazes; (3) Mid-tone
                                                           chromatic animation -- in the
                                                           transitional zone (lum 0.35-0.60),
                                                           add a subtle warm amber ping that
                                                           makes the transitional flesh zones
                                                           glow with the characteristic joyful
                                                           incandescence of her candlelit
                                                           interiors.

  SESSION 96 ARTISTIC IMPROVEMENT -- mid-tone chromatic animation:
                                                           The judith_leyster_joyful_light_pass()
                                                           introduces a new tonal concept to
                                                           the pipeline: mid-tone chromatic
                                                           animation.  Prior sessions have
                                                           accumulated techniques for the
                                                           extremes of the tonal range --
                                                           highlight bloom (session 83),
                                                           sfumato veil (session 82/89),
                                                           shadow vitality (Fabritius session
                                                           95, Hugo van der Goes session 93) --
                                                           but the mid-tone transitional zone
                                                           between full shadow and full
                                                           highlight has been treated mainly
                                                           as a passive gradient.  Leyster's
                                                           candlelit genre scenes reveal that
                                                           this transitional zone is where a
                                                           figure's life resides: the half-
                                                           shadow of a cheek turning from the
                                                           candle, the lower lip catching
                                                           ambient warmth, the temple just
                                                           below the peak highlight.  The
                                                           mid-tone ping adds a targeted warm
                                                           amber stimulus in this zone,
                                                           animating the transitional flesh
                                                           with the joyful incandescent quality
                                                           that defines Leyster's work -- and
                                                           that the Mona Lisa, with its
                                                           famously ambiguous transitional
                                                           expression, can absorb without
                                                           losing its enigmatic character.

  Sessions 95 and earlier (retained):
...
Session 97 artistic character:
  The random artist for this session is Judith Leyster (1609-1660), one of the
  most gifted and historically significant painters of the Dutch Golden Age.
  She was born in Haarlem, the daughter of a brewer, and by her early twenties
  had established herself as an independent artist of the first rank.  In 1633
  she was admitted to the Haarlem Guild of St. Luke -- one of the very few women
  in seventeenth-century Europe to achieve full guild membership -- and shortly
  after ran her own workshop with male apprentices, an achievement without parallel
  in the Dutch art world of her era.

  Leyster was a near-neighbour and occasional rival of Frans Hals, and her
  technique bears the clear imprint of his bravura alla prima method: loaded-
  brush marks, confident and direct, placed with economy and purpose.  But where
  Hals's mature portraiture is cooler and more extroverted -- aimed at the civic
  record, the banquet hall, the collective face of Haarlem -- Leyster's work is
  warmer and more intimate.  Her subjects are typically single figures caught in
  private moments of domestic joy: a fiddler mid-laugh (The Joyful Toper, 1629),
  a child blowing a soap bubble, a seamstress working by candlelight.

  The key to Leyster's distinctive warmth is her relationship to the Utrecht
  Caravaggists -- Hendrick ter Brugghen, Gerard van Honthorst, and Dirck van
  Baburen -- who brought the tenebrism of Caravaggio north from Rome and
  translated it into a warmer, more domestic register.  Honthorst in particular
  specialised in candlelit genre scenes, and his influence on Leyster is clear
  in her handling of artificial light: the orange-amber of a candle just off-
  stage tilts her highlights toward incandescence, making flesh tones glow
  with a warmth that is quite different from the cool daylight of a Vermeer
  or the dramatic chiaroscuro of a Rembrandt.

  Technically, Leyster's most distinctive quality is what I am calling her
  'joyful light' -- the animated warmth of her mid-tone transitional zone.
  In a Rembrandt or a Caravaggio, the transition from light to shadow is a
  drama: the figure emerges from darkness, and the passage between light and
  shadow is a zone of psychological weight.  In Leyster, this same zone is
  inhabited by a warm amber animation -- the half-lit cheek, the lower lip
  catching ambient warmth, the temple just below the highlight.  Her figures
  feel alive in their mid-tones in a way that most Dutch painters reserve for
  their highlights alone.

  This is the quality that the judith_leyster_joyful_light_pass() encodes.
  The incandescent highlight warm-lift handles the peak illumination; the
  shadow vitality (warm imprimatura show-through) prevents the darks from
  going dead or cold; and the mid-tone chromatic animation -- the session 96
  artistic improvement -- adds a targeted warm amber stimulus in the
  transitional lum zone [0.35, 0.60], animating the half-tones with the
  joyful incandescent quality that Leyster makes her own.

  In the context of this Mona Lisa portrait, Leyster's contribution is
  particularly apt.  The Mona Lisa's famous expression lives precisely in
  the transitional zone: the corners of the mouth are caught between smile
  and neutrality, and Leonardo used sfumato to blur the edge so the expression
  is never definitively resolved.  By animating this same transitional zone
  with warm amber life -- while keeping the sfumato dissolution intact from
  session 82/89 -- the Leyster pass adds vitality without resolving the
  ambiguity.  The face remains enigmatic, but its mid-tones now breathe
  with a domestic warmth that grounds the figure's otherworldly quality in
...
def paint(out_dir: str = ".") -> str:
    """Run the full session-97 painting pipeline."""
    print("Session 97 -- Mona Lisa portrait")
    print("Random artist: Bernardino Luini (Milanese Renaissance / Leonardesque, c.1480-1532)")
    print("New pass: luini_leonardesque_glow_pass()")
    print("  -- Incandescent highlight warm-lift: amber-peach shift in upper highlights (lum > 0.65)")
    print("  -- Shadow vitality: warm imprimatura show-through in deep shadows (lum < 0.28)")
    print("  -- Mid-tone chromatic animation: warm amber ping in transitional zone [0.35, 0.60]")
    print()
    print("Session 96 artistic improvement: mid-tone chromatic animation")
    print("  The transitional half-tone zone [lum 0.35-0.60] -- where Leyster's figures")
    print("  feel most alive -- now receives a targeted warm amber stimulus, animating the")
    print("  flesh passages between full shadow and full highlight with joyful incandescence.")
    print()
    ...
    # Session 82 IMPROVED (s89, s97): sfumato veil with shadow_warm_recovery, chroma_gate,
    # and session-97 highlight_ivory_lift (Luini-school lead-white ivory highlight preparation)
    ...
    p.sfumato_veil_pass(
        ...
        chroma_gate            = 0.42,
        highlight_ivory_lift   = 0.06,   # session 97: Luini-school ivory lift before veils
    ...
    # ── SESSION 96: Judith Leyster joyful light pass (NEW) ───────────────────
    # Judith Leyster (1609-1660) -- Dutch Golden Age, Haarlem.
    # Three operations: incandescent highlight warm-lift (amber-peach shift in
    # upper highlights), shadow vitality (warm imprimatura show-through in deep
    # shadows), and mid-tone chromatic animation (warm amber ping in transitional
    # zone [0.35, 0.60] -- the session 96 artistic improvement).
    print("Judith Leyster joyful light pass (session 96 -- NEW)...")
    p.judith_leyster_joyful_light_pass(
        highlight_lo        = 0.65,    # lum threshold for incandescent warm-lift
        highlight_amber_r   = 0.028,   # R boost in peak highlights (amber-orange)
        highlight_amber_g   = 0.012,   # G boost in peak highlights (slight ochre)
        highlight_amber_b   = 0.016,   # B reduction in peak highlights (damp cool)
        shadow_hi           = 0.28,    # upper lum threshold for shadow vitality
        shadow_warm_r       = 0.018,   # R lift in shadows (warm imprimatura)
        shadow_warm_g       = 0.010,   # G lift in shadows
        shadow_warm_b       = 0.003,   # B lift in shadows (very slight)
        mid_lo              = 0.35,    # lower bound of mid-tone animation zone
        mid_hi              = 0.60,    # upper bound of mid-tone animation zone
        mid_amber_r         = 0.016,   # R ping in mid-tones (joyful warmth)
        mid_amber_g         = 0.007,   # G ping in mid-tones
        mid_amber_b         = 0.005,   # B reduction in mid-tones (keep warm)
        blur_radius         = 3.5,
        opacity             = 0.40,
    )


    # ── SESSION 97: Bernardino Luini leonardesque glow pass (NEW) ────────────
    # Bernardino Luini (c. 1480/85-1532) -- Milanese Renaissance / Leonardesque.
    # Three operations: warm-ivory highlight clarification (creamy lead-white
    # ground reading through warm glaze in upper highlights), cool-violet shadow
    # delicacy (ambient sky reflection in deep shadows, a Leonardo inheritance),
    # and sfumato flesh surface smoothing (blend toward seamlessly polished
    # mid-tone surface in [flesh_lo=0.40, flesh_hi=0.74]).
    print("Bernardino Luini leonardesque glow pass (session 97 -- NEW)...")
    p.luini_leonardesque_glow_pass(
        highlight_lo        = 0.70,    # lum threshold for warm-ivory highlight zone
        ivory_r             = 0.028,   # R lift in highlights (warm ivory glow)
        ivory_g             = 0.016,   # G lift in highlights (slight ochre tint)
        ivory_b             = 0.006,   # B lift in highlights (barely perceptible)
        shadow_hi           = 0.32,    # upper lum threshold for cool-violet shadow zone
        shadow_violet_b     = 0.018,   # B lift in shadows (ambient sky / cool air)
        shadow_violet_g     = 0.006,   # G lift in shadows (slight)
        shadow_violet_r     = 0.004,   # R reduction in shadows (remove warm cast)
        flesh_lo            = 0.40,    # lower lum bound of sfumato smoothing zone
        flesh_hi            = 0.74,    # upper lum bound of sfumato smoothing zone
        smooth_sigma        = 1.6,     # Gaussian sigma for flesh surface smoothing
        smooth_strength     = 0.50,    # blend fraction toward smoothed surface
        blur_radius         = 4.0,
        opacity             = 0.38,
    )
    ...
    out_path = os.path.join(out_dir, "mona_lisa_s97.png")
    p.save(out_path)
