"""
paint_s173.py — Session 173 painting with Jan van Huysum-inspired passes.

Runs the HIGH_RENAISSANCE Mona Lisa pipeline then applies:
  - huysum_crystalline_petal_pass (SIXTY-SEVENTH DISTINCT MODE)
  - frequency_domain_acuity_pass (SIXTY-EIGHTH DISTINCT MODE)
"""
import sys, os
...
OUTPUT = "mona_lisa_s173.png"

print("=" * 64)
print("  Mona Lisa — Session 173 (Jan van Huysum inspiration)")
print("  HIGH_RENAISSANCE + huysum_crystalline_petal_pass")
print("  + frequency_domain_acuity_pass")
print("=" * 64)
...
print("  [10/12] Huysum crystalline petal pass (s173)")

p.frequency_domain_acuity_pass(
    freq_lo=0.06,
    freq_hi=0.30,
    boost=1.35,
    luma_lo=0.10,
...
print("  [11/12] Frequency domain acuity pass (s173)")
