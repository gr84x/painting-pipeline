"""
paint_mona_lisa_s184.py — Mona Lisa portrait for session 184.
...
Artistic discovery (session 184): Giacomo Ceruti (il Pitocchetto, 1698–1767)
  - Brescian/Milanese painter, the "painter of the poor"
  - Compassionate, dignified portrayals of humble subjects: beggars, lace-makers,
    pilgrims, itinerant workers — painted with the same authority as nobles
  - Roots in Lombard observational realism: Savoldo, Moretto, Moroni
  - Defining quality: WARM SHADOW DIGNITY — shadows are warm and earthen,
    never cold theatrical voids; figure and setting share the same material warmth
  - The Beggars (c. 1736), Lace-Maker (c. 1720–25), Two Pilgrims Resting (c. 1736)

New pipeline enhancements (session 184):
  - ceruti_dignity_shadow_pass: EIGHTY-EIGHTH DISTINCT MODE
    DOUBLE-BOUNDARY GAUSSIAN BELL-CURVE SHADOW GATE:
    Targets the INHABITED SHADOW ZONE (luma 0.08–0.42) with a Gaussian bell curve
    centred on the zone midpoint — maximum effect at the heart of the shadow,
    fading smoothly to zero at both boundaries (void edge and midtone edge).
    Injects warm sienna-amber in the gated zone: Ceruti's characteristic warm,
    earthen darkness that makes shadows feel inhabited rather than void.
    NOVEL: FIRST pass with a double-boundary symmetric Gaussian shadow gate.

  - hue_coherence_field_pass: EIGHTY-NINTH DISTINCT MODE
    LOCAL DOMINANT HUE COHERENCE VIA CHROMA UNIT-VECTOR GAUSSIAN FIELD:
    Computes local dominant hue direction by Gaussian-blurring the normalised
    chroma unit-vector (C_r/C, C_g/C, C_b/C). Dot product of pixel and field
    hue vectors gives a coherence measure: aligned pixels get saturation boost,
    discordant outliers get mild suppression. Creates local colour coherence —
    warm zones become more cohesively warm, cool zones more cohesively cool.
    NOVEL: FIRST pass to use dot-product hue alignment as the saturation gate.
"""
...
def paint(output_path: str = "mona_lisa_s184.png") -> str:
    """Full Leonardo sfumato pipeline with session 184 Ceruti-inspired passes."""
    print("=" * 64)
    print("  Session 184 — Mona Lisa sfumato portrait")
    print("  Artistic discovery: Giacomo Ceruti (il Pitocchetto, 1698–1767)")
    print("    Lombard Humble Genre — warm earthy shadow dignity")
    print("    The Beggars, Lace-Maker, Two Pilgrims: humble subjects, full dignity")
    print("    EIGHTY-EIGHTH MODE: ceruti_dignity_shadow_pass")
    print("    -- Double-boundary Gaussian bell-curve gate on inhabited shadow zone")
    print("    EIGHTY-NINTH MODE: hue_coherence_field_pass")
    print("    -- Local dominant hue coherence via chroma unit-vector Gaussian field")
    print("=" * 64)
    ...
    print("  [6/32] Edge sfumato dissolution pass ...")
    ...
    print("  [7/32] Figure contour atmosphere pass ...")
    ...
    print("  [8/32] Skin subsurface scatter pass ...")
    ...
    print("  [9/32] Tonal envelope pass ...")
    ...
    print("  [10/32] Selective focus pass ...")
    ...
    print("  [11/32] Massys bridge glazing pass ...")
    ...
    print("  [12/32] Reynolds Grand Manner mezzotint tone pass ...")
    ...
    print("  [13/32] Luminance gradient warmth pass ...")
    ...
    print("  [14/32] Warm ambient occlusion pass ...")
    ...
    print("  [15/32] Shadow color temperature pass ...")
    ...
    print("  [16/32] Multilayer atmospheric veil pass ...")
    ...
    print("  [17/32] Peripheral defocus pass ...")
    ...
    print("  [18/32] Luminance preserving chroma boost pass ...")
    ...
    print("  [19/32] Shadow chroma depth pass ...")
    ...
    print("  [20/32] Tonal bounded warmth pass [s182] ...")
    ...
    print("  [21/32] Canvas tooth texture pass ...")
    ...
    print("  [22/32] Chromatic vignette pass ...")
    ...
    print("  [23/32] Cesare da Sesto clarity pass ...")
    ...
    print("  [24/32] Benozzo Gozzoli pageant pass [s182] ...")
    ...
    print("  [25/32] Sirani contextual warmth pass [s183, 86th mode] ...")
    ...
    print("  [26/32] Adaptive tonal pivot pass [s183, 87th mode] ...")
    ...
    print("  [27/32] *** CERUTI DIGNITY SHADOW PASS [s184, 88th mode] ***")
    ...
    print("  [28/32] *** HUE COHERENCE FIELD PASS [s184, 89th mode] ***")
    ...
    print("  [29/32] Chromatic edge halation pass ...")
    ...
    print("  [30/32] Skin subsurface scatter pass (final warm glow) ...")
    p.skin_subsurface_scatter_pass(
        scatter_sigma    = 3.5,
    ...
    print("  [31/32] Sfumato veil final ...")
    p.sfumato_veil_pass(
        ref,
        n_veils                      = 4,
        blur_radius                  = 8.0,
    ...
    print("  [32/32] Place lights, final glaze + finish ...")
    p.place_lights(ref, stroke_size=5, n_strokes=320)
    p.glaze((0.70, 0.58, 0.38), opacity=0.038)  # warm amber-sienna — Ceruti Lombard ground warmth
...
if __name__ == "__main__":
    out = sys.argv[1] if len(sys.argv) > 1 else "mona_lisa_s184.png"
    paint(out)
