"""
paint_s223_last_light.py — Original composition: "The Last Light of Winter"

Session 223 painting — inspired by Helene Schjerfbeck (1862–1946).
...
Technique & Palette:
  Helene Schjerfbeck style — 134th distinct mode: schjerfbeck_sparse_portrait_pass.
  ...
  halation_glow_pass (session 223 improvement) creates a warm luminous bloom
...
def paint(output_path: str = "s223_last_light.png") -> str:
    """
    Paint 'The Last Light of Winter'.
    Helene Schjerfbeck style: 134th mode — schjerfbeck_sparse_portrait_pass.
    Session 223 improvement: halation_glow_pass.
    """
    print("=" * 64)
    print("  Session 223 — 'The Last Light of Winter'")
    print("  Elderly woman — close portrait, diffuse winter light")
    print("  Technique: Helene Schjerfbeck Finnish Modernism")
    print("  134th mode: schjerfbeck_sparse_portrait_pass")
    print("  + halation_glow_pass (session 223 improvement)")
    print("=" * 64)
    ...
    print("  [6] schjerfbeck_sparse_portrait_pass (134th mode) ...")
    ...
    # ── Session 223 artistic improvement — Halation Glow ─────────────────────
    print("  [7] halation_glow_pass (session 223 improvement) ...")
